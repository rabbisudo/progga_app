...
class ExamRepository {
    ...
    try {
      final response = await _apiClient.dio.post(
        ...
        data: {
          ...
          if (quesStandard != null && quesStandard.isNotEmpty) 'quesStandard': quesStandard,
        },
      );
      return UserExamModel.fromJson(response.data);
    } on DioException catch (e) {
  ...
  Future<List<dynamic>> getBookmarkedQuestions() async {
    try {
      final response = await _apiClient.dio.get('/questions/bookmarks');
      return response.data as List<dynamic>;
    } on DioException catch (e) {
      throw _apiClient.handleError(e);
    }
