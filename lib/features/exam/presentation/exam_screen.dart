...
class _ExamScreenState extends ConsumerState<ExamScreen> {
    ...
    for (int i = 0; i < questions.length; i++) {
      ...
      if (q.subQuestions != null && q.subQuestions!.isNotEmpty) {
        ...
        for (final subQ in q.subQuestions!) {
          ...
          final subMarks = subQ.marks;
          final marksStr = _formatMarks(subMarks);
          String subQText = subQ.questionText;
          ...
          final updatedSubQ = subQ.copyWith(questionText: subQText);
  ...
  String _cleanAndNormalizeMath(String rawText) => cleanAndNormalizeMath(rawText);
          ...
          decoration: BoxDecoration(
            color: filledVal != null
                ? (isActive
                    ...
                    : (isDark ? const Color(0xFF0C273D) : const Color(0xFFF0F9FF)))
                : (isActive
  ...
  Widget _buildFitbClues(String qId, List<String> clues, String rawPassage) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            const Icon(Icons.lightbulb_outline, size: 16, color: Color(0xFF0071F9)),
          ...
          children: clues.map((clue) {
            ...
            return ChoiceChip(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                  color: isUsed ? (isDark ? Colors.white10 : Colors.grey.shade300) : const Color(0xFF0071F9),
                ),
              ),
              onSelected: isUsed
                  ? null
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            icon: Icon(Icons.add, color: isDark ? const Color(0xFF38BDF8) : const Color(0xFF0071F9), size: 18),
            label: Text(
              'পৃষ্ঠা আপলোড করো',
              style: TextStyle(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: isDark ? const Color(0xFF0C203D) : const Color(0xFFE8F1FF),
              elevation: 0,
          ...
          actions: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: (isLowTime ? Colors.redAccent : const Color(0xFF0071F9)).withOpacity(0.05),
                    blurRadius: 6,
                    offset: const Offset(0, 2),
                  ),
                ],
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.image_outlined, color: Color(0xFF0071F9), size: 18),
                          const SizedBox(width: 8),
                          Text(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSelected 
                                        ? const Color(0xFF0071F9).withOpacity(0.12) 
                                        : (isDark ? Colors.white.withOpacity(0.02) : const Color(0xFFFAFAFA)),
                                    borderRadius: BorderRadius.circular(16),
                                    boxShadow: isSelected
                                        ? [
                                            BoxShadow(
                                              color: const Color(0xFF0071F9).withOpacity(0.05),
                                              blurRadius: 8,
                                              offset: const Offset(0, 3),
                                            )
                                          ]
              ...
              child: SafeArea(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: isDark ? Colors.black45 : const Color(0xFF0071F9).withOpacity(0.3),
                        blurRadius: 12,
                        spreadRadius: 1,
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    height: 16,
                    decoration: BoxDecoration(
                      color: const Color(0xFF0071F9).withOpacity(opacity * 0.2),
