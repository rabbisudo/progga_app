...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, dynamic> user, String accessToken)
        authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Map<String, dynamic> user, String accessToken)?
        authenticated,
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(
      {required final Map<String, dynamic> user,
      required final String accessToken}) = _$AuthenticatedImpl;
